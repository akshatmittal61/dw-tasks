...
public class Queries {
    public static final String CREATE_TASKS_TABLE = "CREATE TABLE tasks (id serial primary key DEFAULT uuid_generate_v4(), content varchar(255), completed boolean DEFAULT false, created_at timestamp DEFAULT CURRENT_TIMESTAMP, updated_at timestamp DEFAULT CURRENT_TIMESTAMP)";
