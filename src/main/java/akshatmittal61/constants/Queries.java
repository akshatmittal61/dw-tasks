...
public class Queries {
    ...
    public static final String GET_TASK_BY_ID = "SELECT * FROM tasks WHERE id = :id::UUID";
    public static final String CREATE_TASK = "INSERT INTO tasks (content, completed) VALUES (:content, :completed) RETURNING *";
    public static final String UPDATE_TASK = "UPDATE tasks SET content = :content, completed = :completed, updated_at = CURRENT_TIMESTAMP WHERE id = :id::UUID RETURNING *";
    public static final String DELETE_TASK = "DELETE FROM tasks WHERE id = :id::UUID RETURNING *";
}
